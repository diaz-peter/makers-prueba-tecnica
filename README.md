...
📁 Ver matriz completa en [`functional/Matriz_Casos_Prueba_MakersPay.xlsx`](./functional/Matriz_Casos_Prueba_MakersPay.xlsx) o su versión [Markdown](./functional/Matriz_Casos_Prueba_MakersPay.md)
